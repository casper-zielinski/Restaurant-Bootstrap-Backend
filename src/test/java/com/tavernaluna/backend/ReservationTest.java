...
class ReservationTest {
    private final String fileName = "expected.json";
    ...
    void reservationSerializationTest() throws IOException {
        ...
        assertThat(json.write(reservation)).isStrictlyEqualToJson(fileName);
    ...
    void reservationDeserializationTest() throws Exception {
        Reservation reservation = json.readObject(fileName);
